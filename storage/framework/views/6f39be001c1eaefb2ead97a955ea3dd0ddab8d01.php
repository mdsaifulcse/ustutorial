...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e($info->company_name); ?></title>
...
<div class="wrapper" style="height: auto; min-height: 100%;">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo e(URL::to('/home')); ?>" class="logo">
            ...
            <span class="logo-mini">
                <img src="<?php echo e(asset('images/img/icon-white.png')); ?>" style="width:30px;"/>
            </span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">
                <img src="<?php echo e(asset('images/img/logo.png')); ?>" style="width: 200px;">
            </span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
           ...
           <div class="search-area">
              <span class="logo-lg">
                  <img src="<?php echo e(asset('public/images/img/logo.png')); ?>" style="max-width:200px">
              </span>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <?php if(Auth::user()->image!=null && file_exists(asset(Auth::user()->image))): ?>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a style="background: #fff" href="<?php echo e(URL::to('user-profile')); ?>" class="btn btn-default btn-flat">Profile</a>
                                </div>
                                <div class="pull-right">


                                    <a  style="background: #fff" href="<?php echo e(route('logout')); ?>"
  ...
  <footer class="main-footer" style="display:none">
    ...
    <strong style="display:none">Copyright © <?php echo e(date('Y')); ?> <a href="https://eduleam.com/" target="_blank"><?php echo e($info->company_name); ?></a>.</strong> All rights
    reserved.
  </footer>
...
<?php /**PATH D:\xampp\htdocs\ustutorial\resources\views/backend/app.blade.php ENDPATH**/ ?>