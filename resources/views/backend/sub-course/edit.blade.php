    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Edit Sub Course For All Branch</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <input type="number" step="any" class="form-control" name="student_amount"  id="studentAmount" value="{{old('student_amount')}}" placeholder="Minimum amount for make regular student">
                    </div>
                </div>
