            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Program <u>{{$course->name}}</u></h3>
                            ...
                            <div class="row">
                                <div class="col-md-5 col-lg-5">
                                    <div class="form-group ">
                                        ...
                                        {{Form::text('name', $value=$course->name,['class'=>'form-control','placeholder'=>'Program name','required'=>true])}}
                                ...
                                <div class="col-md-2 col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        {{Form::select('show_at_home', ['0'=>'No Popular Program','1'=>'Include to Popular Program'],$course->show_at_home,['class'=>'form-control','placeholder'=>'-Select one-','required'=>true])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group ">
                                        ...
                                        {{Form::number('price', $value=$course->price,['step'=>'any','class'=>'form-control','placeholder'=>'Program Price','required'=>false])}}
