...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('sub-course')}}"> Program create</a></li>
    </ol>
@endsection
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Program Creation</h3>
                        <div class="box-btn pull-right">

                            <a href="{{URL::to('courses')}}"  class="btn btn-primary btn-xs pull-right" title="click here to view all Program"> <i class="fa fa-list"></i> All Program </a>
                            ...
                            {{--<div class="row">--}}
                                ...
                                {{--<div class="col-md-4 col-lg-4">--}}
                                    {{--<div class="form-group ">--}}
                                        {{--<label class="control-label">Program Category <sup class="text-danger">*</sup> :</label>--}}
                                ...
                                {{--<div class="col-md-4 col-lg-4">--}}
                                    {{--<div class="form-group ">--}}
                                        ...
                                        {{--{{Form::text('course_duration',$value=old('course_duration'),['class'=>'form-control','placeholder'=>'Program Duration( Ex: 7Weeks)','required'=>false])}}--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-lg-5">
                                    <div class="form-group ">
                                        ...
                                        {{Form::text('name', $value=old('name'),['class'=>'form-control','placeholder'=>'Program name','required'=>true])}}
                                ...
                                {{--<div class="col-md-2 col-lg-2">--}}
                                    {{--<div class="form-group ">--}}
                                        ...
                                        {{--{{Form::text('start_date', $value=old('start_date'),['class'=>'singleDatePicker form-control','placeholder'=>'Program start date','required'=>true])}}--}}
                                ...
                                <div class="col-md-2 col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        {{Form::select('show_at_home', ['0'=>'No Popular Program','1'=>'Include to Popular Program'],[],['class'=>'form-control','placeholder'=>'-Select one-','required'=>true])}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group ">
                                        ...
                                        {{Form::number('price', $value=old('price'),['step'=>'any','class'=>'form-control','placeholder'=>'Program Price','required'=>false])}}
